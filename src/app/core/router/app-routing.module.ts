...
const routes: Routes = [
  ...
  // Auth
  {
    ...
    loadChildren: () =>
      import('../../features/user-rides/user-rides.module').then(
        (m) => m.UserRidesModule
      ),
  ...
  },
  {
    ...
    loadChildren: () =>
      import('../../features/bikes/bikes.module').then((m) => m.BikesModule),
  },
  {
  ...
  },
  {
    ...
    loadChildren: () =>
      import('../../features/rides/rides.module').then((m) => m.RidesModule),
    canActivate: [StaffGuardService],
  },
  {
    path: '**',
